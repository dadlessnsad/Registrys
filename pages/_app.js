                ...
                <div className={styles.HeaderDiv}>
                    ...
                    >
                        <svg 
                            ...
                            <path d="M6 6L2 10L6 14" stroke="#18181B" strokeWidth="2.6" strokeLinecap="round" strokeLinejoin="round"/>
                            <rect x="11.3" y="1.3" width="17.4" height="17.4" rx="2.7" stroke="#18181B" strokeWidth="2.6"/>
                            <path d="M34 14L38 10L34 6" stroke="#18181B" strokeWidth="2.6" strokeLinecap="round" strokeLinejoin="round"/>
                    ...
                    <svg className={styles.headerLine} width="1" height="24" viewBox="0 0 1 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <line x1="0.5" y1="2.91408e-08" x2="0.499999" y2="24" stroke="black" strokeOpacity="0.1"/>
                    </svg>
